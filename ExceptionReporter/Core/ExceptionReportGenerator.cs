	...
	public class ExceptionReportGenerator : Disposable
	{
		...
		public ExceptionReportGenerator(ExceptionReportInfo reportInfo)
		{
			...
			_reportInfo.AppVersion = string.IsNullOrEmpty(_reportInfo.AppVersion) ? 
                (ApplicationDeployment.IsNetworkDeployed ? ApplicationDeployment.CurrentDeployment.CurrentVersion.ToString() : Application.ProductVersion) : _reportInfo.AppVersion;
