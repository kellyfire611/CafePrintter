...
namespace ExceptionReporting.Config
{
	...
	public class ConfigReader
	{
		...
		private void ReadContactSettings()
		{
            ...
            _info.ProjectCode = GetContactSetting("ProjectCode").GetString(_info.ProjectCode);
            _info.ProjectName = GetContactSetting("ProjectName").GetString(_info.ProjectName);
		}
		...
		private void ReadMailValues()
		{
            ...
            _info.FolderPath = GetMailSetting("FolderPath").GetString(_info.FolderPath);
		}
