...
namespace ExceptionReporting
{
	...
	public class ExceptionReporter
	{
		...
		public ExceptionReporter()
		{
			...
			_reportInfo.LocalIPv4 = NetworkUtilities.GetLocalIPv4();
			_reportInfo.PublicIPv4 = NetworkUtilities.GetPublicIPv4();
		...
		/// <param name="exceptions">The <see cref="Exception"/>s to show.</param>
		// ReSharper disable MemberCanBePrivate.Global
		public void SendEmailSlient(string customTitle, string customMessage, params Exception[] exceptions)
		{
			if (exceptions == null) return;     //TODO perhaps show a dialog that says "No exception to show" ?

			try
			{
				_reportInfo.CustomTitle = customTitle;
		...
		{
			_reportInfo.CustomTitle = customMessage;
			Show(exceptions);
		}
