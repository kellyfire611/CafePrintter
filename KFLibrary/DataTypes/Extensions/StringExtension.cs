...
namespace KFLibrary.DataTypes.Extensions
{
    public static class StringExtension
    {
        ...
        /// <returns></returns>
        public static List<Int64?> ChuyenChuoiThanhListNumber(this string strCanChuyen, string[] separators)
        {
            List<Int64?> listKQ = new List<Int64?>();
            listKQ =
                    strCanChuyen
                    .Split(separators, StringSplitOptions.RemoveEmptyEntries)
                    .Select(p => p.ConvertToNullable())
                    .ToList();
            return listKQ;
        ...
        public static Nullable<Int64> ConvertToNullable(this object obj)
        {
            Nullable<Int64> value = null;
            //ttnhi 19/03/2015, cải thiện tốc độ khi convert lỗi
            Int64 outValue = 0;
            try
            {
                if(obj == null)
                ...
                else if (Int64.TryParse((obj+string.Empty), out outValue))
                {
