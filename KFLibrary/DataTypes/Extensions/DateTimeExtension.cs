...
using System.Text;
using KFLibrary.SystemDependencies;
...
namespace KFLibrary.DataTypes.Extensions
{
    ...
    public static class DateTimeExtension
    {
        ...
        public static string DayOfWeekVietnamese(this DateTime value)
        {
        ...
        public static string ToStringVietnamese(this DateTime value)
        {
            return value.ToFullStringVietnamese("dd/MM/yyyy");
        }

        public static string ToFullStringVietnamese(this DateTime value, string format)
        {
            // Thứ bảy, ngày 27 tháng 10 năm 2012
            StringBuilder sb = new StringBuilder();
            // In thứ
            sb.Append(value.DayOfWeekVietnamese());
            sb.Append(", ");
            // In ngày tháng năm theo chuỗi định dạng
        ...
        {
            var firstDayOfMonth = value.FirstDayOfMonth();
        ...
        {
            var firstDayOfYear = value.FirstDayOfYear();
